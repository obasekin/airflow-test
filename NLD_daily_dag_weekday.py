...
GCS_BASE_PATH = "output/mobility/NLD"
...
def druid_ingestion_workflow():
    ...
    def check_manifest_ready(
        ...
        from scripts.NLD.NLD_druid_ingestion.manifest_checker import (
            find_manifest
        )
    ...
    def execute_idempotent_druid_ingestion(
        ...
        from scripts.NLD.NLD_druid_ingestion.ingestion_druid import (
            run_ingestion,
        )
